...
@section('sub-heading','Daftar Berita')
        ...
        <div class="container">
            ...
            <div class="section-name">
                ...
                <div class="short-text">
                    <h5>Home<i class="fa fa-angle-double-right"></i>@yield('sub-heading')</h5>
                </div>
            </div>
        </div>
    </div>
			...
			<div class="row">
				<div class="blog-posts col-md-8">
	                <div class="blog-box">
						...
						<img class="img-responsive" src="{{asset('user/img/blog/img-4.jpg')}}" alt="">
						...
						<div class="blog-post">
							<div id="post-slider" class="owl-carousel owl-theme owl-transitions">
								<div class="item img-wrapper">
									<img class="img-responsive" src="{{asset('user/img/blog/img-5')}}.jpg" alt="">
								</div>
								<div class="item img-wrapper">
									<img  class="img-responsive" src="{{asset('user/img/blog/img-6')}}.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="blog-btm-desc">
							...
							<div class="recent-posts clearfix">
								<div class="post clearfix">
									<div class="image-wrapper">
										...
										<img src="{{asset('user/img/mini/img-1.jpg')}}" alt="">
									</div>
								...
								<div class="post clearfix">
									<div class="image-wrapper">
										<div class="mask"><a href="#"><i class="fa fa-link"></i></a></div>
										<img src="{{asset('user/img/mini/img-2.jpg')}}" alt="">
									</div>
									<div class="info-block">
								...
								<div class="post clearfix">
									<div class="image-wrapper">
										<div class="mask"><a href="#"><i class="fa fa-link"></i></a></div>
										<img src="{{asset('user/img/mini/img-3.jpg')}}" alt="">
									</div>
									<div class="info-block">
										<a href="#"><h4>Let's Build Them a New School</h4></a>
										<div class="meta">
