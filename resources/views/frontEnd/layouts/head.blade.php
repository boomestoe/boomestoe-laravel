    ...
    <link rel="stylesheet" href="{{asset('frontEnd/assets/owl-carousel/assets/owl.carousel.min.css')}}">
     <link rel="stylesheet" href="{{asset('frontEnd/assets/owl-carousel/assets/owl.theme.default.css')}}">
